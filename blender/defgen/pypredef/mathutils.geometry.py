...
def closest_point_on_tri(pt, tri_p1, tri_p2, tri_p3):
   '''Takes 4 vectors: one is the point and the next 3 define the triangle.
      ...
      @returns (mathutils.Vector): The closest point of the triangle.
   '''
...
def delaunay_2d_cdt(vert_coords, edges, faces, output_type, epsilon, need_ids=True):
   '''Computes the Constrained Delaunay Triangulation of a set of vertices,
      ...
      @output_type (int\n   :arg epsilon: For nearness tests; should not be zero): What output looks like. 0 => triangles with convex hull. 1 => triangles inside constraints. 2 => the input constraints, intersected. 3 => like 2 but detect holes and omit them from output. 4 => like 2 but with extra edges to make valid BMesh faces. 5 => like 4 but detect holes and omit them from output.
      @need_ids: are the orig output arrays needed?

      @returns ((list of mathutils.Vector, list of (int, int), list of list of int, list of list of int, list of list of int, list of list of int)): Output tuple, (vert_coords, edges, faces, orig_verts, orig_edges, orig_faces)
   '''

   return (list of mathutils.Vector, list of (int, int), list of list of int, list of list of int, list of list of int, list of list of int)
