...
class Euler:
   '''.. class:: Euler(angles, order='XYZ')
      ...
      (seealso Euler angles <https://en.wikipedia.org/wiki/Euler_angles>__ on Wikipedia.:param angles: Three angles, in radians.
   ...
   def to_matrix():
      '''Return a matrix representation of the euler.
         ...
         @returns (mathutils.Matrix): A 3x3 rotation matrix representation of the euler.
      '''
...
class Matrix:
   ...
   def Diagonal(vector):
      '''Create a diagonal (scaling) matrix using the values from the vector.
         ...
         @returns (mathutils.Matrix): A diagonal matrix.
      '''
   ...
   @classmethod
   def LocRotScale(location, rotation, scale):
      '''Create a matrix combining translation, rotation and scale,
         ...
         @returns (4x4 Matrix): Combined transformation matrix. 
      '''
   ...
   def adjugated():
      '''Return an adjugated copy of the matrix.
         ...
         @returns (mathutils.Matrix): the adjugated matrix.:raises ValueError: if the matrix cannot be adjugated
   ...
   def decompose():
      '''Return the translation, rotation, and scale components of this matrix.
         ...
         @returns ((Vector, Quaternion, Vector)): tuple of translation, rotation, and scale
      '''
...
class Quaternion:
   ...
   def to_swing_twist(axis):
      '''Split the rotation into a swing quaternion with the specified
         ...
         @returns ((Quaternion, float) pair): swing, twist angle.
      '''
   
      return (Quaternion, float) pair
